---
name: refactor-agent
description: Uses quality reports to identify and fix architectural drift, complexity spikes, and dependency cycles.
---
...
## 3. Implementation
1. Read the specific report file in `.agent/reports/` (or equivalent location).
